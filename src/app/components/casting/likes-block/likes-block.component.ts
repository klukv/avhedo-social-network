...
export class LikesBlockComponent {
  ...
  constructor(public friendsService: FriendsService, public castingService: CastingService, private render: Renderer2){
    
  }

  clickLikeCard(indexCard: number){
    if(this.likeButtonsBlock !== undefined && this.chatButton !== undefined && this.likeButtons !== undefined){
      ...
      this.render.setStyle(this.likeButtons.toArray()[indexCard].nativeElement, 'opacity', '0');
      ...
      setTimeout(() => {
        ...
        this.render.setStyle(currentChatBlock, 'transform', `translateX(${this._widthButtonsBlock}px)`);
      }, 200);
    }
  }
